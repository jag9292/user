...
print(jimbo.name)
jimbo.display_user_balance().make_deposit(200).make_deposit(100).make_deposit(120).make_withdrawal(50).display_user_balance()

print(al.name)
al.display_user_balance().make_deposit(120).make_deposit(120).make_withdrawal(50).make_withdrawal(70).display_user_balance()

print(tom.name)
tom.display_user_balance().make_deposit(80).make_withdrawal(50).make_withdrawal(90).make_withdrawal(120).display_user_balance()
